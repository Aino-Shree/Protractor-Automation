...
function createdChannelWebsiteCheck(sourceName) {
  ...
  browser.getCurrentUrl().then(function (text: string) {
    expect(text.toString()).toBe(browser.params.baseUrl + '#connection:' + sourceName );
...
function createdChannelFTPCheck(url, sourceName) {
  element(<Locator>by.xpath('/html/body/table/tbody/tr/td/div/div[2]/div[2]/div/div[2]/div/div[2]/table[1]/tbody[1]')).click();
...
function createdChannelSFTPCheck(url, sourceName) {
  element(<Locator>by.xpath('/html/body/table/tbody/tr/td/div/div[2]/div[2]/div/div[2]/div/div[2]/table[1]/tbody[1]'))
  .click();
