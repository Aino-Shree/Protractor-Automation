...
function publication(){
    describe('Add Publication',function(){
        it('Added Pub',function(){
        sourceList();
             search('milind');
             publicationName('pub4');
               calender('01/01/2020');
            //  expCalender('01/01/2021');
        })
    });
}
// source list
...
function search (sourceName){
  ...
  expect(text.toString()).toBe(browser.params.baseUrl+'#source:milind');
...
browser.sleep(3000);
// dropdown
element(<Locator>by.xpath('/html/body/table/tbody/tr/td/div/div[2]/div[2]/div/div[2]/div/div[2]/select/option[2]')).click();
browser.sleep(3000);
...
function calender(date){
  ...
  cal.sendKeys(date);
   browser.sleep(3000); 
   // select language
element(<Locator>by.xpath('/html/body/table/tbody/tr/td/div/div[2]/div[2]/div/div[8]/select')).element(<Locator>by.css("option[value='Italian']")).click();
browser.sleep(5000); 
// select Category
element(<Locator>by.xpath('/html/body/table/tbody/tr/td/div/div[2]/div[2]/div/div[9]/select')).element(<Locator>by.css("option[value='Arts & Photography']")).click();
browser.sleep(5000);
// select Country
element(<Locator>by.xpath('/html/body/table/tbody/tr/td/div/div[2]/div[2]/div/div[10]/select')).element(<Locator>by.css("option[value='Italy']")).click();
browser.sleep(5000);
// save buttonclick
